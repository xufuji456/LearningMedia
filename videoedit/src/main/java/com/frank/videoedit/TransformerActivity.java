...
public final class TransformerActivity extends AppCompatActivity {
  ...
  private void startTransformation() {
    ...
    try {
      ...
      com.frank.videoedit.transform.entity.MediaItem newMediaItem =
              com.frank.videoedit.transform.entity.MediaItem.fromUri(mediaItem.localConfiguration.uri);
        ...
        .addListener(
            new Transformer.Listener() {
              ...
              public void onTransformationCompleted(
                  com.frank.videoedit.transform.entity.MediaItem mediaItem, TransformationResult transformationResult) {
                MediaItem newMediaItem = MediaItem.fromUri(mediaItem.uri);
                TransformerActivity.this.onTransformationCompleted(filePath, /*mediaItem*/newMediaItem);
              }

              @Override
              public void onTransformationError(
                      com.frank.videoedit.transform.entity.MediaItem mediaItem, TransformationException exception) {
