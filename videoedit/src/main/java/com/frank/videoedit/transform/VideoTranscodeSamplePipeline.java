 ...
 */
public final class VideoTranscodeSamplePipeline extends BaseSamplePipeline {
      ...
      frameProcessor =
          frameProcessorFactory.create(
              ...
              new FrameProcessor.Listener() {
                ...
                @Override
                public void onFrameProcessingError(RuntimeException exception) {
  ...
  private static TransformationRequest createSupportedTransformationRequest(
    ...
    if (transformationRequest.enableRequestSdrToneMapping == isToneMappedToSdr
        && requestedFormat.sampleMimeType.equals(supportedFormat.sampleMimeType)
