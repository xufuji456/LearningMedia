...
Java_com_frank_media_MediaJniHelper_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_frank_media_MediaJniHelper_setIntData(JNIEnv *env, jobject thiz, jintArray jdata) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_frank_media_MediaJniHelper_testReflect(JNIEnv *env, jobject thiz) {
    jclass clazz = env->FindClass("com/frank/media/MediaJniHelper");
